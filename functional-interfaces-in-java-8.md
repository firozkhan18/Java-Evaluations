...
| :- | :- | :- | :- | :- |
|<p>Supplier</p><p>T get()</p>|<p>Represents</p><p>operation</p><p>nothing but</p><p>result of type</p><p>an Use this interface</p><p>which takes\_ |you want to</p><p>returns a objects.</p><p>T.</p><p>when</p><p>create new</p><p>BooleanSupplier</p><p>IntSupplier</p><p>LongSupplier</p><p>DoubleSupplier</p>|
